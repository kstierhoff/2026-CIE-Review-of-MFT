...
Since estimates of $a$ are not readily available, $A$ is estimated using the following equation for the area of an ellipse:

$$A = \pi b \sqrt{\frac{P^2}{2\pi^2} - b^2}$$ 
where $P$ is the perimeter of the net opening.

The Nordic 264 has an 12 m-high opening and a 28 m-wide opening with a nominal area of 336 m\^2. From that, the perimeter is estimated to be 65.7 m (LITZ ET AL.: NORTHERN ANCHOVY ECOLOGY AND DISTRIBUTION CalCOFI Rep., Vol. 49, 2008).
