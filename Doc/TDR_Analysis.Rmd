...
# Mouth opening of the Nordic264 was nominally 336m2 (12 meters by 28m), perimeter is 65.7
...
# Per Grok, the area of an ellipse can be approximated by the following equation given a known height and perimeter
# area = \(\pi b \sqrt{\frac{P^2}{2\pi^2} - b^2}\)
b = 9
P = 87.2
