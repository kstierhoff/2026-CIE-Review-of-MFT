...
ggplot(filter(dat, scientificName %in% sl.spp), 
...
ggsave(filename = here("Figs/fig_standartLengths_all.png"),
       height = 7, width = 7)

ggplot(filter(dat, scientificName %in% fl.spp), 
...
ggsave(filename = here("Figs/fig_forkLengths_all.png"),
       height = 7, width = 7)

# ggplot(filter(dat, scientificName %in% fl.spp), 
#        aes(forkLength_mm, group = season, fill = season, position = "identity")) + 
